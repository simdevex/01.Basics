'''
Python program which reads the two adjoined sides
and the diagonal of a parallelogram and check whether the
...
(non-self-intersecting) quadrilateral with two pairs of parallel sides.
...
angle, and the latter sometimes refers specifically to a rhombus
with a 45° angle.
Input:
...
if c**2 == a**2+b**2 :
    ...
    print("This neither a rectangle or rhombus")